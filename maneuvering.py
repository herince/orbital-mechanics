...
def hohmannTransfer(apar, atar):
    ...
    print("V parking: {0:.5f}km/s".format(vpar / KM))
    print("V transfer - perigee: {0:.5f}km/s".format(vtransperigee / KM))
    print("Delta V1: {0:.5f}km/s".format(deltaV1 / KM))
    ...
    print("V transfer - apogee: {0:.5f}km/s".format(vtransapogee / KM))
    print("V target: {0:.5f}km/s".format(vtar / KM))
    print("Delta V2: {0:.5f}km/s".format(deltaV2 / KM))

    deltaV = np.abs(deltaV1) + np.abs(deltaV2);
    print("Delta V: {0:.5f}km/s".format(deltaV / KM))
...
def biellipticTransfer(apar, atar, f):
    ...
    print("SMA parking: {0:.5f}km".format(apar / KM))
    print("SMA transfer 1: {0:.5f}km".format(atrans1 / KM))
    print("V transfer 1 - perigee: {0:.5f}km/s".format(vtrans1perigee / KM))
    print("Delta V1: {0:.5f}km/s".format(deltaV1 / KM))
    ...
    print("SMA transfer 2: {0:.5f}km".format(atrans2 / KM))
    print("V transfer 1 - apogee: {0:.5f}km/s".format(vtrans1apogee / KM))
    print("V transfer 2 - apogee: {0:.5f}km/s".format(vtrans2apogee / KM))
    print("Delta V2: {0:.5f}km/s".format(deltaV2 / KM))
    ...
    print("V transfer 2 - perigee: {0:.5f}km/s".format(vtrans2perigee / KM))
    print("V target: {0:.5f}km/s".format(vtar / KM))
    print("Delta V3: {0:.5f}km/s".format(deltaV3 / KM)) 
